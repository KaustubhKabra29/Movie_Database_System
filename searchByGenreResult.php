  ...
  <body style="background:#B19CD9";>
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li> <a href="searchByActor.php" >Search Movies of Actor</a> </li> 
    ...
    <?php
     ...
     //$Query = query($_POST["return-type"], $_POST["param-type"], $_POST["param-value"]);
      ...
      $Query = "SELECT * FROM In_Genre t1 JOIN Shows t2 ON t1.Show_Id = t2.Show_Id JOIN Genres t3 ON t1.Genre_Id = t3.Genre_Id where t3.Name ='".$_POST["Genre"]. "';";
