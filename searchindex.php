...
.btn-gradient.green:active  {background: #72B08E;}
  ...
  <body style="background-image: url('ViewIndex.jpg')";>
    <nav class="navbar navbar-default" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li> <a href="searchByDire.php" >Search Movies of Director</a> </li> 
    ...
    <div class="container">
        ...
        <a href="searchByActor.php" class="btn-two green large">Search Shows of Actor</a>
        <a href="searchByDire.php" class="btn-two blue large">Search Shows of Director</a>
        <a href="getActors.php" class="btn-two red large">Search Actors of Movies</a>
        <a href="MovieRatings.php" class="btn-two purple large">Search Rating By Movie</a>
        <a href="YearlyCollections.php" class="btn-two cyan large">Search Highest grossing Movie</a>
        <a href="yearly.php" class="btn-two yellow large">Search Movie by year</a>
	<a href="searchByGenre.php" class="btn-two red large">Search Movie by Genre</a>
    </div>
