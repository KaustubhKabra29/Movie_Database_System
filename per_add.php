  ...
  <body style="background:#B19CD9";>
    ...
    <?php
     ...
     //$Query = query($_POST["return-type"], $_POST["param-type"], $_POST["param-value"]);
      ...
      $Query = "INSERT INTO person (first_name, last_name, birth_date, death_date) VALUES ('".$_POST["fname"]."','".$_POST["lname"]."','".$_POST["bdate"]."','".$_POST["ddate"]."');";
      display_query($Query, $_POST["fname"]);
    ?> 
