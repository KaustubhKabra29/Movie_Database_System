...
<html>
  ...
  <body style="background:#B19CD9";>
    ...
    <main class="container">
      ...
      <form role="form" action="MovieRatingsResult.php" method="post">



        <div class="form-group">
          <label for="mvr">Enter the Movie Name</label>
          <input name="mvr" type="text" class="form-control" id="mvr" placeholder="Input Movie Name">
        </div>
