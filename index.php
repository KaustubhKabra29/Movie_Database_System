...
.btn-gradient.green:active  {background: #72B08E;}
  ...
  <body style="background-image: url('ViewIndex.jpg')";>
    ...
    <div class="container">
        ...
        <a href="viewdbindex.php" class="btn-two green large">View DataBase</a>
        <a href="searchindex.php" class="btn-two blue large">Searching</a>
        <a href="adddataindex.php" class="btn-two red large">Add Data</a>
